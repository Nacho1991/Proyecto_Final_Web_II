...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion: @producto.descripcion, estado: @producto.estado, nombre: @producto.nombre }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { descripcion: @producto.descripcion, estado: @producto.estado, nombre: @producto.nombre }
    assert_redirected_to producto_path(assigns(:producto))
  end
